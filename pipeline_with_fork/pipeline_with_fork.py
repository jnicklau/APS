...
cmap_list=[((25, 28), "green"), ((28, 31), "yellowgreen"), ((31, 34), "yellow"), ((34, 37), "orange"), ((37, 40), "red")]
cmap, norm = phf.cmap_discrete(cmap_list)

jc = plot.create_junction_collection(net, net.junction.index, size=0.1, zorder=2, cmap=cmap, norm=norm)

cmap_list=[((-10, 0), "silver"), ((0, 5), "green"), ((5, 7), "yellowgreen"), ((7, 9), "yellow"), ((9,11), "red")]
cmap, norm = phf.cmap_discrete(cmap_list)

pc = plot.create_pipe_collection(net, net.pipe.index, zorder=1, linewidths=4, cmap=cmap, norm=norm)
